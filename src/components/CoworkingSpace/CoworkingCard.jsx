...
import { FALLBACK_IMAGE } from './coworkingData';

const CoworkingCard = ({ space }) => {
  ...
  return (
    <div className="group flex flex-col w-full transition-transform duration-300">
      ...
      <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-slate-100 shadow-xs">
        ...
        {/* Badge: Popular / Premium (Matching screenshot: white pill, crown emoji) */}
        {space.badge && (
        ...
        {/* Carousel Navigation Arrows: Completely hidden by default, ONLY show on hover */}
        {images.length > 1 && (
          <>
            <button
              type="button"
